...
main(int argc, char *argv[])
{
  ...
  1f:	b8 58 08 00 00       	mov    $0x858,%eax
  24:	eb 05                	jmp    2b <main+0x2b>
  26:	b8 5a 08 00 00       	mov    $0x85a,%eax
  ...
  45:	c7 44 24 04 5c 08 00 	movl   $0x85c,0x4(%esp)
  4c:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 425:	0f b6 80 ac 0a 00 00 	movzbl 0xaac(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 582:	75 09                	jne    58d <printf+0x101>
          s = "(null)";
 584:	c7 45 f4 61 08 00 00 	movl   $0x861,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 64e:	a1 c8 0a 00 00       	mov    0xac8,%eax
...
free(void *ap)
{
 ...
 719:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 71e:	c9                   	leave  
 71f:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 76c:	e8 ce fe ff ff       	call   63f <free>
  return freep;
 771:	a1 c8 0a 00 00       	mov    0xac8,%eax
}
 776:	c9                   	leave  
 777:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 79b:	c7 45 f0 c0 0a 00 00 	movl   $0xac0,-0x10(%ebp)
 7a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7a5:	a3 c8 0a 00 00       	mov    %eax,0xac8
 7aa:	a1 c8 0a 00 00       	mov    0xac8,%eax
 7af:	a3 c0 0a 00 00       	mov    %eax,0xac0
    base.s.size = 0;
 7b4:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 7bb:	00 00 00 
  }
 ...
 811:	a3 c8 0a 00 00       	mov    %eax,0xac8
      return (void*)(p + 1);
 ...
 81c:	eb 38                	jmp    856 <malloc+0xde>
    ...
    if(p == freep)
 81e:	a1 c8 0a 00 00       	mov    0xac8,%eax
