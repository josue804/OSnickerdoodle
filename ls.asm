...
ls(char *path)
{
  ...
  df:	c7 44 24 04 47 0b 00 	movl   $0xb47,0x4(%esp)
  e6:	00 
  e7:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  ee:	e8 88 06 00 00       	call   77b <printf>
    return;
 ...
 118:	c7 44 24 04 5b 0b 00 	movl   $0xb5b,0x4(%esp)
 11f:	00 
 ...
 183:	c7 44 24 04 6f 0b 00 	movl   $0xb6f,0x4(%esp)
 18a:	00 
 18b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 192:	e8 e4 05 00 00       	call   77b <printf>
    break;
 ...
 1b1:	c7 44 24 04 7c 0b 00 	movl   $0xb7c,0x4(%esp)
 1b8:	00 
 1b9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1c0:	e8 b6 05 00 00       	call   77b <printf>
      break;
 ...
 269:	c7 44 24 04 5b 0b 00 	movl   $0xb5b,0x4(%esp)
 270:	00 
 271:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 278:	e8 fe 04 00 00       	call   77b <printf>
        continue;
 ...
 2b3:	c7 44 24 04 6f 0b 00 	movl   $0xb6f,0x4(%esp)
 2ba:	00 
 2bb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 2c2:	e8 b4 04 00 00       	call   77b <printf>
      break;
    }
    strcpy(buf, path);
    p = buf+strlen(buf);
...
main(int argc, char *argv[])
{
 ...
 311:	7f 11                	jg     324 <main+0x20>
    ls(".");
 313:	c7 04 24 8f 0b 00 00 	movl   $0xb8f,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6d6:	74 17                	je     6ef <printint+0x2c>
 6d8:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
 6dc:	79 11                	jns    6ef <printint+0x2c>
    neg = 1;
 ...
 6ed:	eb 06                	jmp    6f5 <printint+0x32>
  } else {
    x = xx;
 ...
 6f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
  ...
  i = 0;
 6f5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
 6fc:	8b 4d f4             	mov    -0xc(%ebp),%ecx
 6ff:	8d 41 01             	lea    0x1(%ecx),%eax
 ...
 714:	0f b6 80 30 0e 00 00 	movzbl 0xe30(%eax),%eax
 71b:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
 ...
 733:	75 c7                	jne    6fc <printint+0x39>
  if(neg)
 735:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 739:	74 10                	je     74b <printint+0x88>
    buf[i++] = '-';
 73b:	8b 45 f4             	mov    -0xc(%ebp),%eax
 73e:	8d 50 01             	lea    0x1(%eax),%edx
 741:	89 55 f4             	mov    %edx,-0xc(%ebp)
 744:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
 749:	eb 1f                	jmp    76a <printint+0xa7>
 74b:	eb 1d                	jmp    76a <printint+0xa7>
    putc(fd, buf[i]);
 ...
 765:	e8 31 ff ff ff       	call   69b <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
 ...
 772:	79 d9                	jns    74d <printint+0x8a>
    putc(fd, buf[i]);
}
 774:	83 c4 30             	add    $0x30,%esp
 777:	5b                   	pop    %ebx
 778:	5e                   	pop    %esi
 779:	5d                   	pop    %ebp
 77a:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
 ...
 798:	e9 7c 01 00 00       	jmp    919 <printf+0x19e>
    c = fmt[i] & 0xff;
 ...
 7c6:	e9 4a 01 00 00       	jmp    915 <printf+0x19a>
      } else {
        putc(fd, c);
 ...
 7db:	e8 bb fe ff ff       	call   69b <putc>
 7e0:	e9 30 01 00 00       	jmp    915 <printf+0x19a>
      }
    } else if(state == '%'){
 7e5:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
 7e9:	0f 85 26 01 00 00    	jne    915 <printf+0x19a>
      if(c == 'd'){
 7ef:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
 7f3:	75 2d                	jne    822 <printf+0xa7>
        printint(fd, *ap, 10, 1);
 7f5:	8b 45 e8             	mov    -0x18(%ebp),%eax
 7f8:	8b 00                	mov    (%eax),%eax
 7fa:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
 801:	00 
 802:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
 809:	00 
 80a:	89 44 24 04          	mov    %eax,0x4(%esp)
 80e:	8b 45 08             	mov    0x8(%ebp),%eax
 811:	89 04 24             	mov    %eax,(%esp)
 814:	e8 aa fe ff ff       	call   6c3 <printint>
        ap++;
 819:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 81d:	e9 ec 00 00 00       	jmp    90e <printf+0x193>
      } else if(c == 'x' || c == 'p'){
 822:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
 826:	74 06                	je     82e <printf+0xb3>
 828:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
 82c:	75 2d                	jne    85b <printf+0xe0>
        printint(fd, *ap, 16, 0);
 82e:	8b 45 e8             	mov    -0x18(%ebp),%eax
 831:	8b 00                	mov    (%eax),%eax
 833:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
 83a:	00 
 83b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
 842:	00 
 843:	89 44 24 04          	mov    %eax,0x4(%esp)
 847:	8b 45 08             	mov    0x8(%ebp),%eax
 84a:	89 04 24             	mov    %eax,(%esp)
 84d:	e8 71 fe ff ff       	call   6c3 <printint>
        ap++;
 852:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 856:	e9 b3 00 00 00       	jmp    90e <printf+0x193>
      } else if(c == 's'){
 85b:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
 85f:	75 45                	jne    8a6 <printf+0x12b>
        s = (char*)*ap;
 ...
 871:	75 09                	jne    87c <printf+0x101>
          s = "(null)";
 873:	c7 45 f4 91 0b 00 00 	movl   $0xb91,-0xc(%ebp)
        while(*s != 0){
 87a:	eb 1e                	jmp    89a <printf+0x11f>
 87c:	eb 1c                	jmp    89a <printf+0x11f>
          putc(fd, *s);
 ...
 891:	e8 05 fe ff ff       	call   69b <putc>
          s++;
 896:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
 ...
 8a2:	75 da                	jne    87e <printf+0x103>
 8a4:	eb 68                	jmp    90e <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
 8a6:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
 8aa:	75 1d                	jne    8c9 <printf+0x14e>
        putc(fd, *ap);
 8ac:	8b 45 e8             	mov    -0x18(%ebp),%eax
 ...
 8be:	e8 d8 fd ff ff       	call   69b <putc>
        ap++;
 8c3:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
 8c7:	eb 45                	jmp    90e <printf+0x193>
      } else if(c == '%'){
 8c9:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
 8cd:	75 17                	jne    8e6 <printf+0x16b>
        putc(fd, c);
 ...
 8df:	e8 b7 fd ff ff       	call   69b <putc>
 8e4:	eb 28                	jmp    90e <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 8e6:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
 8ed:	00 
 8ee:	8b 45 08             	mov    0x8(%ebp),%eax
 8f1:	89 04 24             	mov    %eax,(%esp)
 8f4:	e8 a2 fd ff ff       	call   69b <putc>
        putc(fd, c);
 ...
 909:	e8 8d fd ff ff       	call   69b <putc>
      }
      state = 0;
 90e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 915:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 ...
 926:	0f 85 71 fe ff ff    	jne    79d <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
 ...
 996:	75 24                	jne    9bc <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
 998:	8b 45 f8             	mov    -0x8(%ebp),%eax
 99b:	8b 50 04             	mov    0x4(%eax),%edx
 ...
 a08:	a3 5c 0e 00 00       	mov    %eax,0xe5c
}
 a0d:	c9                   	leave  
 a0e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a2e:	e8 18 fc ff ff       	call   64b <sbrk>
 a33:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
 a36:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
 ...
 a5b:	e8 ce fe ff ff       	call   92e <free>
  return freep;
 a60:	a1 5c 0e 00 00       	mov    0xe5c,%eax
}
 a65:	c9                   	leave  
 a66:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a79:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a7c:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 a81:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a84:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a88:	75 23                	jne    aad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a8a:	c7 45 f0 54 0e 00 00 	movl   $0xe54,-0x10(%ebp)
 a91:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a94:	a3 5c 0e 00 00       	mov    %eax,0xe5c
 a99:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 a9e:	a3 54 0e 00 00       	mov    %eax,0xe54
    base.s.size = 0;
 aa3:	c7 05 58 0e 00 00 00 	movl   $0x0,0xe58
 aaa:	00 00 00 
  }
 ...
 b00:	a3 5c 0e 00 00       	mov    %eax,0xe5c
      return (void*)(p + 1);
 ...
 b0b:	eb 38                	jmp    b45 <malloc+0xde>
    ...
    if(p == freep)
 b0d:	a1 5c 0e 00 00       	mov    0xe5c,%eax
 b12:	39 45 f4             	cmp    %eax,-0xc(%ebp)
 b15:	75 1b                	jne    b32 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
 b17:	8b 45 ec             	mov    -0x14(%ebp),%eax
