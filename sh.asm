...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 40 18 00 00 	mov    0x1840(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 14 18 00 00 	movl   $0x1814,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 1b 18 00 	movl   $0x181b,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 cb 13 00 00       	call   1446 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 2b 18 00 	movl   $0x182b,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 78 13 00 00       	call   1446 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 3b 18 00 00 	movl   $0x183b,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 58 18 00 	movl   $0x1858,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 21 12 00 00       	call   1446 <printf>
  memset(buf, 0, nbuf);
...
setbuiltin(char *p)
{
  ...
  p += strlen("_set");
     310:	c7 04 24 5b 18 00 00 	movl   $0x185b,(%esp)
  ...
  while (strncmp(p, " ", 1) == 0) p++; // chomp spaces
     ...
     32c:	00 
     32d:	c7 44 24 04 60 18 00 	movl   $0x1860,0x4(%esp)
     334:	00 
  ...
  if (strncmp("uid", p, 3) == 0) {
    ...
    while (strncmp(p, " ", 1) == 0) p++; // chomp spaces
     ...
     37f:	00 
     380:	c7 44 24 04 60 18 00 	movl   $0x1860,0x4(%esp)
     387:	00 
    ...
    return (setuid(i));
     ...
     3ab:	e8 ae 0f 00 00       	call   135e <setuid>
  ...
  if (strncmp("gid", p, 3) == 0) {
     ...
     3c4:	c7 04 24 66 18 00 00 	movl   $0x1866,(%esp)
     3cb:	e8 99 fe ff ff       	call   269 <strncmp>
     3d0:	85 c0                	test   %eax,%eax
     3d2:	75 4f                	jne    423 <setbuiltin+0x119>
    p += strlen("gid");
     3d4:	c7 04 24 66 18 00 00 	movl   $0x1866,(%esp)
    ...
    while (strncmp(p, " ", 1) == 0) p++; // chomp spaces
     ...
     3f0:	00 
     3f1:	c7 44 24 04 60 18 00 	movl   $0x1860,0x4(%esp)
     3f8:	00 
  ...
  printf(2, "Invalid _set parameter\n");
     423:	c7 44 24 04 6a 18 00 	movl   $0x186a,0x4(%esp)
     42a:	00 
     42b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     432:	e8 0f 10 00 00       	call   1446 <printf>
  return -1;
...
getbuiltin(char *p)
{
  ...
  p += strlen("_get");
     444:	c7 04 24 82 18 00 00 	movl   $0x1882,(%esp)
  ...
  while (strncmp(p, " ", 1) == 0) p++; // chomp spaces
     ...
     460:	00 
     461:	c7 44 24 04 60 18 00 	movl   $0x1860,0x4(%esp)
     468:	00 
  ...
  if (strncmp("gid", p, 3) == 0) {
     ...
     4ca:	c7 04 24 66 18 00 00 	movl   $0x1866,(%esp)
...
dobuiltin(char *cmd) {
  ...
  for (i=0; i<FDTcount; i++) 
    ...
    if (strncmp(cmd, fdt[i].cmd, strlen(fdt[i].cmd)) == 0) 
     ...
     52b:	8b 04 c5 74 1e 00 00 	mov    0x1e74(,%eax,8),%eax
     532:	89 04 24             	mov    %eax,(%esp)
     535:	e8 80 0b 00 00       	call   10ba <strlen>
     53a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     53d:	8b 14 d5 74 1e 00 00 	mov    0x1e74(,%edx,8),%edx
     ...
     55e:	8b 04 c5 78 1e 00 00 	mov    0x1e78(,%eax,8),%eax
...
dobuiltin(char *cmd) {
  ...
  for (i=0; i<FDTcount; i++) 
     ...
     571:	a1 84 1e 00 00       	mov    0x1e84,%eax
     ...
     59b:	eb 1f                	jmp    5bc <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     5a4:	00 
     5a5:	c7 04 24 a3 18 00 00 	movl   $0x18a3,(%esp)
...
// add support for built-ins here. cd is a built-in
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     60f:	00 
     610:	c7 44 24 04 ab 18 00 	movl   $0x18ab,0x4(%esp)
     617:	00 
     618:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     61f:	e8 22 0e 00 00       	call   1446 <printf>
      continue;
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     691:	c7 44 24 04 b9 18 00 	movl   $0x18b9,0x4(%esp)
     698:	00 
     699:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     6a0:	e8 a1 0d 00 00       	call   1446 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     6be:	c7 04 24 bd 18 00 00 	movl   $0x18bd,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     6dc:	e8 51 10 00 00       	call   1732 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     71a:	e8 13 10 00 00       	call   1732 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     785:	e8 a8 0f 00 00       	call   1732 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7d5:	e8 58 0f 00 00       	call   1732 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     825:	e8 08 0f 00 00       	call   1732 <malloc>
     ...
     86f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     888:	c7 04 24 88 1e 00 00 	movl   $0x1e88,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     932:	c7 04 24 88 1e 00 00 	movl   $0x1e88,(%esp)
     ...
     94f:	c7 04 24 8e 1e 00 00 	movl   $0x1e8e,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     98d:	c7 04 24 88 1e 00 00 	movl   $0x1e88,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     9d3:	c7 04 24 88 1e 00 00 	movl   $0x1e88,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     a4e:	c7 44 24 08 c2 18 00 	movl   $0x18c2,0x8(%esp)
     a55:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     a77:	c7 44 24 04 c3 18 00 	movl   $0x18c3,0x4(%esp)
     a7e:	00 
     a7f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     a86:	e8 bb 09 00 00       	call   1446 <printf>
    panic("syntax");
     a8b:	c7 04 24 d2 18 00 00 	movl   $0x18d2,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     af8:	c7 44 24 08 d9 18 00 	movl   $0x18d9,0x8(%esp)
     aff:	00 
  ...
  if(peek(ps, es, ";")){
     b16:	c7 44 24 08 db 18 00 	movl   $0x18db,0x8(%esp)
     b1d:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     b9a:	c7 44 24 08 dd 18 00 	movl   $0x18dd,0x8(%esp)
     ba1:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     c58:	c7 04 24 df 18 00 00 	movl   $0x18df,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     d04:	c7 44 24 08 fc 18 00 	movl   $0x18fc,0x8(%esp)
     d0b:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     d31:	c7 44 24 08 ff 18 00 	movl   $0x18ff,0x8(%esp)
     d38:	00 
    ...
    panic("parseblock");
     d4f:	c7 04 24 01 19 00 00 	movl   $0x1901,(%esp)
  ...
  if(!peek(ps, es, ")"))
     d92:	c7 44 24 08 0c 19 00 	movl   $0x190c,0x8(%esp)
     d99:	00 
    ...
    panic("syntax - missing )");
     db0:	c7 04 24 0e 19 00 00 	movl   $0x190e,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     e05:	c7 44 24 08 ff 18 00 	movl   $0x18ff,0x8(%esp)
     e0c:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ea2:	74 0c                	je     eb0 <parseexec+0xb1>
      panic("syntax");
     ea4:	c7 04 24 d2 18 00 00 	movl   $0x18d2,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ed5:	7e 0c                	jle    ee3 <parseexec+0xe4>
      panic("too many args");
     ed7:	c7 04 24 21 19 00 00 	movl   $0x1921,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     eff:	c7 44 24 08 2f 19 00 	movl   $0x192f,0x8(%esp)
     f06:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     f69:	8b 04 85 34 19 00 00 	mov    0x1934(,%eax,4),%eax
     f70:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    1372:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    1379:	00 
    137a:	8d 45 f4             	lea    -0xc(%ebp),%eax
    137d:	89 44 24 04          	mov    %eax,0x4(%esp)
    1381:	8b 45 08             	mov    0x8(%ebp),%eax
    1384:	89 04 24             	mov    %eax,(%esp)
    1387:	e8 22 ff ff ff       	call   12ae <write>
}
    138c:	c9                   	leave  
    138d:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    13a1:	74 17                	je     13ba <printint+0x2c>
    13a3:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    13a7:	79 11                	jns    13ba <printint+0x2c>
    neg = 1;
    ...
    13b8:	eb 06                	jmp    13c0 <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    ...
    13df:	0f b6 80 96 1e 00 00 	movzbl 0x1e96(%eax),%eax
    13e6:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    13ea:	8b 75 10             	mov    0x10(%ebp),%esi
    ...
    13fe:	75 c7                	jne    13c7 <printint+0x39>
  if(neg)
    1400:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1404:	74 10                	je     1416 <printint+0x88>
    buf[i++] = '-';
  ...
  while(--i >= 0)
    1435:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    1439:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    143d:	79 d9                	jns    1418 <printint+0x8a>
    putc(fd, buf[i]);
}
    143f:	83 c4 30             	add    $0x30,%esp
    1442:	5b                   	pop    %ebx
    1443:	5e                   	pop    %esi
    1444:	5d                   	pop    %ebp
    1445:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
    1453:	8d 45 0c             	lea    0xc(%ebp),%eax
    1456:	83 c0 04             	add    $0x4,%eax
    1459:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    145c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    1463:	e9 7c 01 00 00       	jmp    15e4 <printf+0x19e>
    c = fmt[i] & 0xff;
    1468:	8b 55 0c             	mov    0xc(%ebp),%edx
    ...
    147b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    147e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1482:	75 2c                	jne    14b0 <printf+0x6a>
      if(c == '%'){
    1484:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1488:	75 0c                	jne    1496 <printf+0x50>
        state = '%';
    148a:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    1491:	e9 4a 01 00 00       	jmp    15e0 <printf+0x19a>
      } else {
        putc(fd, c);
    1496:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1499:	0f be c0             	movsbl %al,%eax
    149c:	89 44 24 04          	mov    %eax,0x4(%esp)
    14a0:	8b 45 08             	mov    0x8(%ebp),%eax
    14a3:	89 04 24             	mov    %eax,(%esp)
    14a6:	e8 bb fe ff ff       	call   1366 <putc>
    14ab:	e9 30 01 00 00       	jmp    15e0 <printf+0x19a>
      }
    } else if(state == '%'){
    14b0:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    14b4:	0f 85 26 01 00 00    	jne    15e0 <printf+0x19a>
      if(c == 'd'){
    14ba:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    14be:	75 2d                	jne    14ed <printf+0xa7>
        printint(fd, *ap, 10, 1);
    ...
    14df:	e8 aa fe ff ff       	call   138e <printint>
        ap++;
    14e4:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    14e8:	e9 ec 00 00 00       	jmp    15d9 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    14ed:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    14f1:	74 06                	je     14f9 <printf+0xb3>
    14f3:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    14f7:	75 2d                	jne    1526 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    ...
    1518:	e8 71 fe ff ff       	call   138e <printint>
        ap++;
    151d:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1521:	e9 b3 00 00 00       	jmp    15d9 <printf+0x193>
      } else if(c == 's'){
    1526:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    152a:	75 45                	jne    1571 <printf+0x12b>
        s = (char*)*ap;
    ...
    153c:	75 09                	jne    1547 <printf+0x101>
          s = "(null)";
    153e:	c7 45 f4 4c 19 00 00 	movl   $0x194c,-0xc(%ebp)
        while(*s != 0){
    1545:	eb 1e                	jmp    1565 <printf+0x11f>
    1547:	eb 1c                	jmp    1565 <printf+0x11f>
          putc(fd, *s);
    ...
    155c:	e8 05 fe ff ff       	call   1366 <putc>
          s++;
    ...
    156d:	75 da                	jne    1549 <printf+0x103>
    156f:	eb 68                	jmp    15d9 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    1571:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    1575:	75 1d                	jne    1594 <printf+0x14e>
        putc(fd, *ap);
    ...
    1589:	e8 d8 fd ff ff       	call   1366 <putc>
        ap++;
    158e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1592:	eb 45                	jmp    15d9 <printf+0x193>
      } else if(c == '%'){
    1594:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1598:	75 17                	jne    15b1 <printf+0x16b>
        putc(fd, c);
    ...
    15aa:	e8 b7 fd ff ff       	call   1366 <putc>
    15af:	eb 28                	jmp    15d9 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    15b1:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    15b8:	00 
    15b9:	8b 45 08             	mov    0x8(%ebp),%eax
    15bc:	89 04 24             	mov    %eax,(%esp)
    15bf:	e8 a2 fd ff ff       	call   1366 <putc>
        putc(fd, c);
    ...
    15d4:	e8 8d fd ff ff       	call   1366 <putc>
      }
      state = 0;
    15d9:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    15e0:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    15e4:	8b 55 0c             	mov    0xc(%ebp),%edx
    15e7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    15ea:	01 d0                	add    %edx,%eax
    15ec:	0f b6 00             	movzbl (%eax),%eax
    15ef:	84 c0                	test   %al,%al
    15f1:	0f 85 71 fe ff ff    	jne    1468 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1608:	a1 2c 1f 00 00       	mov    0x1f2c,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16d3:	a3 2c 1f 00 00       	mov    %eax,0x1f2c
}
    16d8:	c9                   	leave  
    16d9:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    16dd:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    16e0:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    16e7:	77 07                	ja     16f0 <morecore+0x16>
    nu = 4096;
    16e9:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    16f0:	8b 45 08             	mov    0x8(%ebp),%eax
    16f3:	c1 e0 03             	shl    $0x3,%eax
    16f6:	89 04 24             	mov    %eax,(%esp)
    16f9:	e8 18 fc ff ff       	call   1316 <sbrk>
    16fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    1701:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1705:	75 07                	jne    170e <morecore+0x34>
    return 0;
    1707:	b8 00 00 00 00       	mov    $0x0,%eax
    170c:	eb 22                	jmp    1730 <morecore+0x56>
  hp = (Header*)p;
    170e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1711:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    1714:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1717:	8b 55 08             	mov    0x8(%ebp),%edx
    171a:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    171d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1720:	83 c0 08             	add    $0x8,%eax
    1723:	89 04 24             	mov    %eax,(%esp)
    1726:	e8 ce fe ff ff       	call   15f9 <free>
  return freep;
    172b:	a1 2c 1f 00 00       	mov    0x1f2c,%eax
}
    1730:	c9                   	leave  
    1731:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    173b:	83 c0 07             	add    $0x7,%eax
    173e:	c1 e8 03             	shr    $0x3,%eax
    1741:	83 c0 01             	add    $0x1,%eax
    1744:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1747:	a1 2c 1f 00 00       	mov    0x1f2c,%eax
    174c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    174f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1753:	75 23                	jne    1778 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1755:	c7 45 f0 24 1f 00 00 	movl   $0x1f24,-0x10(%ebp)
    175c:	8b 45 f0             	mov    -0x10(%ebp),%eax
    175f:	a3 2c 1f 00 00       	mov    %eax,0x1f2c
    1764:	a1 2c 1f 00 00       	mov    0x1f2c,%eax
    1769:	a3 24 1f 00 00       	mov    %eax,0x1f24
    base.s.size = 0;
    176e:	c7 05 28 1f 00 00 00 	movl   $0x0,0x1f28
    1775:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1778:	8b 45 f0             	mov    -0x10(%ebp),%eax
    177b:	8b 00                	mov    (%eax),%eax
    177d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    1780:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1783:	8b 40 04             	mov    0x4(%eax),%eax
    1786:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1789:	72 4d                	jb     17d8 <malloc+0xa6>
      if(p->s.size == nunits)
    178b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    178e:	8b 40 04             	mov    0x4(%eax),%eax
    1791:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    1794:	75 0c                	jne    17a2 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    1796:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1799:	8b 10                	mov    (%eax),%edx
    179b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    179e:	89 10                	mov    %edx,(%eax)
    17a0:	eb 26                	jmp    17c8 <malloc+0x96>
      else {
        p->s.size -= nunits;
    17a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    17a5:	8b 40 04             	mov    0x4(%eax),%eax
    17a8:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    17b9:	c1 e0 03             	shl    $0x3,%eax
    17bc:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    17bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    17c2:	8b 55 ec             	mov    -0x14(%ebp),%edx
    17c5:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    17c8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17cb:	a3 2c 1f 00 00       	mov    %eax,0x1f2c
      return (void*)(p + 1);
    17d0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    17d3:	83 c0 08             	add    $0x8,%eax
    17d6:	eb 38                	jmp    1810 <malloc+0xde>
    }
    if(p == freep)
    17d8:	a1 2c 1f 00 00       	mov    0x1f2c,%eax
    17dd:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    17e0:	75 1b                	jne    17fd <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    17e2:	8b 45 ec             	mov    -0x14(%ebp),%eax
    17e5:	89 04 24             	mov    %eax,(%esp)
    17e8:	e8 ed fe ff ff       	call   16da <morecore>
    17ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
    17f0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    17f4:	75 07                	jne    17fd <malloc+0xcb>
        return 0;
    17f6:	b8 00 00 00 00       	mov    $0x0,%eax
    17fb:	eb 13                	jmp    1810 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    180b:	e9 70 ff ff ff       	jmp    1780 <malloc+0x4e>
}
    1810:	c9                   	leave  
    1811:	c3                   	ret    
