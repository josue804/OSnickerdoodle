...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e5:	c7 44 24 04 ce 44 00 	movl   $0x44ce,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 78 3f 00 00       	call   406d <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     108:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 55 3f 00 00       	call   406d <printf>
    exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b4:	c7 44 24 04 fe 44 00 	movl   $0x44fe,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 a9 3e 00 00       	call   406d <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1d1:	c7 44 24 04 10 45 00 	movl   $0x4510,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 8c 3e 00 00       	call   406d <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 1f 45 00 00 	movl   $0x451f,(%esp)
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     1f6:	c7 44 24 04 25 45 00 	movl   $0x4525,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 67 3e 00 00       	call   406d <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     21e:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 3f 3e 00 00       	call   406d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 1f 45 00 00 	movl   $0x451f,(%esp)
    ...
    if(fd >= 0){
     ...
     25b:	c7 44 24 04 3c 45 00 	movl   $0x453c,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 02 3e 00 00       	call   406d <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 1f 45 00 00 	movl   $0x451f,(%esp)
    ...
    printf(stdout, "unlink failed\n");
     ...
     296:	c7 44 24 04 60 45 00 	movl   $0x4560,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 c7 3d 00 00       	call   406d <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2b5:	c7 44 24 04 6f 45 00 	movl   $0x456f,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 a8 3d 00 00       	call   406d <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2d2:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 8b 3d 00 00       	call   406d <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 3c 44 00 00 	movl   $0x443c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     304:	c7 44 24 04 8c 45 00 	movl   $0x458c,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 59 3d 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 9f 45 00 00 	movl   $0x459f,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     346:	c7 44 24 04 ac 45 00 	movl   $0x45ac,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 17 3d 00 00       	call   406d <printf>
    exit();
     356:	e8 5a 3b 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 fc 62 00 00       	mov    0x62fc,%eax
     360:	c7 44 24 04 ca 45 00 	movl   $0x45ca,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 fd 3c 00 00       	call   406d <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     37d:	c7 44 24 04 d8 45 00 	movl   $0x45d8,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 e0 3c 00 00       	call   406d <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 e9 45 00 00 	movl   $0x45e9,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3af:	c7 44 24 04 ef 45 00 	movl   $0x45ef,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 ae 3c 00 00       	call   406d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3d0:	c7 44 24 04 0a 46 00 	movl   $0x460a,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 8d 3c 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 26 46 00 	movl   $0x4626,0x4(%esp)
     3f4:	00 
     ...
     411:	c7 44 24 04 34 46 00 	movl   $0x4634,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 4c 3c 00 00       	call   406d <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 58 46 00 	movl   $0x4658,0x4(%esp)
     435:	00 
     ...
     452:	c7 44 24 04 64 46 00 	movl   $0x4664,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 0b 3c 00 00       	call   406d <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     47a:	c7 44 24 04 88 46 00 	movl   $0x4688,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 e3 3b 00 00       	call   406d <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 e9 45 00 00 	movl   $0x45e9,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4b7:	c7 44 24 04 93 46 00 	movl   $0x4693,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 a6 3b 00 00       	call   406d <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4f5:	c7 44 24 04 ac 46 00 	movl   $0x46ac,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 68 3b 00 00       	call   406d <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     50f:	c7 44 24 04 c7 46 00 	movl   $0x46c7,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 4e 3b 00 00       	call   406d <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 e9 45 00 00 	movl   $0x45e9,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     541:	c7 44 24 04 da 46 00 	movl   $0x46da,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 1c 3b 00 00       	call   406d <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     55b:	c7 44 24 04 e7 46 00 	movl   $0x46e7,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 02 3b 00 00       	call   406d <printf>
    exit();
     56b:	e8 45 39 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 fc 62 00 00       	mov    0x62fc,%eax
     575:	c7 44 24 04 fc 46 00 	movl   $0x46fc,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 e8 3a 00 00       	call   406d <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     592:	c7 44 24 04 10 47 00 	movl   $0x4710,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 cb 3a 00 00       	call   406d <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 20 47 00 00 	movl   $0x4720,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     5c4:	c7 44 24 04 24 47 00 	movl   $0x4724,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 99 3a 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     61a:	c7 44 24 04 3e 47 00 	movl   $0x473e,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 43 3a 00 00       	call   406d <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 20 47 00 00 	movl   $0x4720,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     66a:	c7 44 24 04 5c 47 00 	movl   $0x475c,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 f3 39 00 00       	call   406d <printf>
    exit();
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6bf:	c7 44 24 04 75 47 00 	movl   $0x4775,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 9e 39 00 00       	call   406d <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 20 47 00 00 	movl   $0x4720,(%esp)
     ...
     70b:	c7 44 24 04 92 47 00 	movl   $0x4792,0x4(%esp)
     712:	00 
     713:	89 04 24             	mov    %eax,(%esp)
     716:	e8 52 39 00 00       	call   406d <printf>
      exit();
    ...
    if(((int*)buf)[0] != n){
     ...
     743:	c7 44 24 04 a4 47 00 	movl   $0x47a4,0x4(%esp)
     74a:	00 
     74b:	89 04 24             	mov    %eax,(%esp)
     74e:	e8 1a 39 00 00       	call   406d <printf>
             n, ((int*)buf)[0]);
      exit();
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     ...
     766:	c7 44 24 04 c4 47 00 	movl   $0x47c4,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 f7 38 00 00       	call   406d <printf>
    exit();
     776:	e8 3a 37 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 fc 62 00 00       	mov    0x62fc,%eax
     780:	c7 44 24 04 d7 47 00 	movl   $0x47d7,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 dd 38 00 00       	call   406d <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     79d:	c7 44 24 04 e8 47 00 	movl   $0x47e8,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 c0 38 00 00       	call   406d <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     838:	c7 44 24 04 10 48 00 	movl   $0x4810,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 25 38 00 00       	call   406d <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     855:	c7 44 24 04 36 48 00 	movl   $0x4836,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 08 38 00 00       	call   406d <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 42 48 00 00 	movl   $0x4842,(%esp)
     86c:	e8 ac 36 00 00       	call   3f1d <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 fc 62 00 00       	mov    0x62fc,%eax
     87a:	c7 44 24 04 65 44 00 	movl   $0x4465,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 e3 37 00 00       	call   406d <printf>
    exit();
     88a:	e8 26 36 00 00       	call   3eb5 <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 42 48 00 00 	movl   $0x4842,(%esp)
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8a4:	c7 44 24 04 47 48 00 	movl   $0x4847,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 b9 37 00 00       	call   406d <printf>
    exit();
     8b4:	e8 fc 35 00 00       	call   3eb5 <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 5a 48 00 00 	movl   $0x485a,(%esp)
     8c0:	e8 60 36 00 00       	call   3f25 <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 fc 62 00 00       	mov    0x62fc,%eax
     8ce:	c7 44 24 04 5d 48 00 	movl   $0x485d,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 8f 37 00 00       	call   406d <printf>
    exit();
     8de:	e8 d2 35 00 00       	call   3eb5 <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 42 48 00 00 	movl   $0x4842,(%esp)
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     8f8:	c7 44 24 04 6e 48 00 	movl   $0x486e,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 65 37 00 00       	call   406d <printf>
    exit();
     908:	e8 a8 35 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 fc 62 00 00       	mov    0x62fc,%eax
     912:	c7 44 24 04 82 48 00 	movl   $0x4882,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 4b 37 00 00       	call   406d <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     92f:	c7 44 24 04 91 48 00 	movl   $0x4891,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 2e 37 00 00       	call   406d <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 e8 62 00 	movl   $0x62e8,0x4(%esp)
     946:	00 
     947:	c7 04 24 3c 44 00 00 	movl   $0x443c,(%esp)
    ...
    printf(stdout, "exec echo failed\n");
     ...
     95c:	c7 44 24 04 9c 48 00 	movl   $0x489c,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 01 37 00 00       	call   406d <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 ae 48 00 	movl   $0x48ae,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 d1 36 00 00       	call   406d <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a1a:	c7 44 24 04 bd 48 00 	movl   $0x48bd,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 3f 36 00 00       	call   406d <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a90:	c7 44 24 04 cb 48 00 	movl   $0x48cb,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 c9 35 00 00       	call   406d <printf>
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 d9 48 00 	movl   $0x48d9,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 53 35 00 00       	call   406d <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 ff 48 00 	movl   $0x48ff,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 2a 35 00 00       	call   406d <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 f0 48 00 	movl   $0x48f0,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 14 35 00 00       	call   406d <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 09 49 00 	movl   $0x4909,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 f3 34 00 00       	call   406d <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 13 49 00 	movl   $0x4913,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 15 49 00 	movl   $0x4915,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 7b 34 00 00       	call   406d <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 29 49 00 	movl   $0x4929,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 2f 34 00 00       	call   406d <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 3c 49 00 	movl   $0x493c,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 0e 34 00 00       	call   406d <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 45 49 00 	movl   $0x4945,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 d9 33 00 00       	call   406d <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 4e 49 00 	movl   $0x494e,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 b6 33 00 00       	call   406d <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 83 33 00 00       	call   406d <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 5a 49 00 	movl   $0x495a,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 5d 33 00 00       	call   406d <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 6a 49 00 	movl   $0x496a,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 38 33 00 00       	call   406d <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 77 49 00 	movl   $0x4977,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 1c 33 00 00       	call   406d <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 cb 35 00 00       	call   4359 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 74 34 00 00       	call   4220 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 24 34 00 00       	call   4220 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 9b 49 00 	movl   $0x499b,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 5d 32 00 00       	call   406d <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 a3 49 00 	movl   $0x49a3,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 37 32 00 00       	call   406d <printf>

  unlink("sharedfd");
     e36:	c7 04 24 b2 49 00 00 	movl   $0x49b2,(%esp)
     e3d:	e8 c3 30 00 00       	call   3f05 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 b2 49 00 00 	movl   $0x49b2,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 bc 49 00 	movl   $0x49bc,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 fa 31 00 00       	call   406d <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 e8 49 00 	movl   $0x49e8,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 88 31 00 00       	call   406d <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 b2 49 00 00 	movl   $0x49b2,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 08 4a 00 	movl   $0x4a08,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 2d 31 00 00       	call   406d <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 b2 49 00 00 	movl   $0x49b2,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 33 4a 00 	movl   $0x4a33,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 7e 30 00 00       	call   406d <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 40 4a 00 	movl   $0x4a40,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 5a 30 00 00       	call   406d <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 55 4a 00 00 	movl   $0x4a55,-0x38(%ebp)
    1027:	c7 45 cc 58 4a 00 00 	movl   $0x4a58,-0x34(%ebp)
    102e:	c7 45 d0 5b 4a 00 00 	movl   $0x4a5b,-0x30(%ebp)
    1035:	c7 45 d4 5e 4a 00 00 	movl   $0x4a5e,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 61 4a 00 	movl   $0x4a61,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 1d 30 00 00       	call   406d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 da 2f 00 00       	call   406d <printf>
      exit();
    ...
    10be:	c7 44 24 04 71 4a 00 	movl   $0x4a71,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 9b 2f 00 00       	call   406d <printf>
        exit();
    ...
    112c:	c7 44 24 04 80 4a 00 	movl   $0x4a80,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 2d 2f 00 00       	call   406d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 91 4a 00 	movl   $0x4a91,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 89 2e 00 00       	call   406d <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    123a:	c7 44 24 04 9d 4a 00 	movl   $0x4a9d,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 1f 2e 00 00       	call   406d <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 ae 4a 00 	movl   $0x4aae,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 ed 2d 00 00       	call   406d <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    1297:	e8 d1 2d 00 00       	call   406d <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 a3 2d 00 00       	call   406d <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 71 4a 00 	movl   $0x4a71,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 42 2d 00 00       	call   406d <printf>
          exit();
    ...
    136c:	c7 44 24 04 60 45 00 	movl   $0x4560,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 ed 2c 00 00       	call   406d <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 d0 4a 00 	movl   $0x4ad0,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 30 2c 00 00       	call   406d <printf>
        exit();
    ...
    145b:	c7 44 24 04 f4 4a 00 	movl   $0x4af4,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 fe 2b 00 00       	call   406d <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 14 4b 00 	movl   $0x4b14,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 75 2b 00 00       	call   406d <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 25 4b 00 	movl   $0x4b25,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 59 2b 00 00       	call   406d <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 36 4b 00 00 	movl   $0x4b36,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 41 4b 00 	movl   $0x4b41,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 28 2b 00 00       	call   406d <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 5b 4b 00 	movl   $0x4b5b,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 36 4b 00 00 	movl   $0x4b36,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    162c:	c7 44 24 04 97 4b 00 	movl   $0x4b97,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 2d 2a 00 00       	call   406d <printf>
    exit();
  ...
  if(buf[0] != 'h'){
    ...
    1650:	c7 44 24 04 ae 4b 00 	movl   $0x4bae,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 09 2a 00 00       	call   406d <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1689:	c7 44 24 04 c5 4b 00 	movl   $0x4bc5,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 d0 29 00 00       	call   406d <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 36 4b 00 00 	movl   $0x4b36,(%esp)
    16b4:	e8 4c 28 00 00       	call   3f05 <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 de 4b 00 	movl   $0x4bde,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 a0 29 00 00       	call   406d <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 ed 4b 00 	movl   $0x4bed,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 84 29 00 00       	call   406d <printf>

  unlink("lf1");
    16e9:	c7 04 24 f7 4b 00 00 	movl   $0x4bf7,(%esp)
    16f0:	e8 10 28 00 00       	call   3f05 <unlink>
  unlink("lf2");
    16f5:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    16fc:	e8 04 28 00 00       	call   3f05 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 f7 4b 00 00 	movl   $0x4bf7,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 ff 4b 00 	movl   $0x4bff,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 3b 29 00 00       	call   406d <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 5b 4b 00 	movl   $0x4b5b,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 12 4c 00 	movl   $0x4c12,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 02 29 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 61 4c 00 	movl   $0x4c61,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 53 28 00 00       	call   406d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    183f:	c7 44 24 04 72 4c 00 	movl   $0x4c72,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 1a 28 00 00       	call   406d <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 fb 4b 00 	movl   $0x4bfb,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    1872:	e8 9e 26 00 00       	call   3f15 <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 83 4c 00 	movl   $0x4c83,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 de 27 00 00       	call   406d <printf>
    exit();
    188f:	e8 21 26 00 00       	call   3eb5 <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    189b:	e8 65 26 00 00       	call   3f05 <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 f7 4b 00 	movl   $0x4bf7,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 fb 4b 00 00 	movl   $0x4bfb,(%esp)
    18af:	e8 61 26 00 00       	call   3f15 <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 a4 4c 00 	movl   $0x4ca4,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 a1 27 00 00       	call   406d <printf>
    exit();
    18cc:	e8 e4 25 00 00       	call   3eb5 <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 f7 4b 00 	movl   $0x4bf7,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 c7 4c 00 00 	movl   $0x4cc7,(%esp)
    18e0:	e8 30 26 00 00       	call   3f15 <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 c9 4c 00 	movl   $0x4cc9,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 70 27 00 00       	call   406d <printf>
    exit();
    18fd:	e8 b3 25 00 00       	call   3eb5 <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 57 27 00 00       	call   406d <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 f2 4c 00 	movl   $0x4cf2,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 3b 27 00 00       	call   406d <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 02 4d 00 00 	movl   $0x4d02,(%esp)
    ...
    19d4:	c7 04 24 02 4d 00 00 	movl   $0x4d02,(%esp)
    ...
    1a05:	c7 44 24 04 05 4d 00 	movl   $0x4d05,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 54 26 00 00       	call   406d <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 c7 4c 00 00 	movl   $0x4cc7,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 21 4d 00 	movl   $0x4d21,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 8d 25 00 00       	call   406d <printf>
        exit();
    ...
    1afe:	c7 44 24 04 3a 4d 00 	movl   $0x4d3a,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 5b 25 00 00       	call   406d <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 58 4d 00 	movl   $0x4d58,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 00 25 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 c4 24 00 00       	call   406d <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 89 4d 00 	movl   $0x4d89,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 a4 23 00 00       	call   406d <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 97 4d 00 	movl   $0x4d97,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 88 23 00 00       	call   406d <printf>

  unlink("x");
    1ce5:	c7 04 24 13 49 00 00 	movl   $0x4913,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 5a 23 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 13 49 00 00 	movl   $0x4913,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 13 49 00 	movl   $0x4913,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 a8 4d 00 00 	movl   $0x4da8,(%esp)
    1db0:	e8 60 21 00 00       	call   3f15 <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 13 49 00 00 	movl   $0x4913,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 ac 4d 00 	movl   $0x4dac,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 76 22 00 00       	call   406d <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 bb 4d 00 	movl   $0x4dbb,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 5a 22 00 00       	call   406d <printf>
  unlink("bd");
    1e13:	c7 04 24 c8 4d 00 00 	movl   $0x4dc8,(%esp)
    1e1a:	e8 e6 20 00 00       	call   3f05 <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 c8 4d 00 00 	movl   $0x4dc8,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 cb 4d 00 	movl   $0x4dcb,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 1d 22 00 00       	call   406d <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 c8 4d 00 00 	movl   $0x4dc8,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 f5 4d 00 	movl   $0x4df5,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 2f 21 00 00       	call   406d <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 0a 4e 00 	movl   $0x4e0a,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 09 21 00 00       	call   406d <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 15 4e 00 	movl   $0x4e15,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 ed 20 00 00       	call   406d <printf>

  unlink("ff");
    1f80:	c7 04 24 22 4e 00 00 	movl   $0x4e22,(%esp)
    1f87:	e8 79 1f 00 00       	call   3f05 <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 25 4e 00 00 	movl   $0x4e25,(%esp)
    1f93:	e8 85 1f 00 00       	call   3f1d <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 28 4e 00 	movl   $0x4e28,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 bd 20 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 40 4e 00 00 	movl   $0x4e40,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 46 4e 00 	movl   $0x4e46,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 87 20 00 00       	call   406d <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 22 4e 00 	movl   $0x4e22,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 a4 4e 00 00 	movl   $0x4ea4,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 ad 4e 00 	movl   $0x4ead,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 d9 1f 00 00       	call   406d <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 c5 4e 00 	movl   $0x4ec5,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 c8 4e 00 00 	movl   $0x4ec8,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 d4 4e 00 	movl   $0x4ed4,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 7d 1f 00 00       	call   406d <printf>
    exit();
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2124:	c7 44 24 04 ed 4e 00 	movl   $0x4eed,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 35 1f 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 08 4f 00 00 	movl   $0x4f08,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 d2 4f 00 	movl   $0x4fd2,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 c5 1d 00 00       	call   406d <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22cd:	c7 44 24 04 ea 4f 00 	movl   $0x4fea,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 8c 1d 00 00       	call   406d <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    239c:	c7 44 24 04 77 50 00 	movl   $0x5077,0x4(%esp)
    23a3:	00 
    23a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    23ab:	e8 bd 1c 00 00       	call   406d <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 64 52 00 	movl   $0x5264,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 a7 19 00 00       	call   406d <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 73 52 00 00 	movl   $0x5273,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 73 52 00 00 	movl   $0x5273,(%esp)
    ...
    26fb:	c7 44 24 04 7c 52 00 	movl   $0x527c,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 5e 19 00 00       	call   406d <printf>
      exit();
    ...
    2750:	c7 44 24 04 94 52 00 	movl   $0x5294,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 09 19 00 00       	call   406d <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 73 52 00 00 	movl   $0x5273,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 a6 52 00 	movl   $0x52a6,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 bb 18 00 00       	call   406d <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 b3 52 00 	movl   $0x52b3,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 9f 18 00 00       	call   406d <printf>

  unlink("bigfile");
    27ce:	c7 04 24 c1 52 00 00 	movl   $0x52c1,(%esp)
    27d5:	e8 2b 17 00 00       	call   3f05 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 c1 52 00 00 	movl   $0x52c1,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 c9 52 00 	movl   $0x52c9,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 62 18 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2856:	c7 44 24 04 df 52 00 	movl   $0x52df,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 03 18 00 00       	call   406d <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 c1 52 00 00 	movl   $0x52c1,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 f5 52 00 	movl   $0x52f5,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 b8 17 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28ec:	c7 44 24 04 0a 53 00 	movl   $0x530a,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 6d 17 00 00       	call   406d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 1f 53 00 	movl   $0x531f,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 2a 17 00 00       	call   406d <printf>
      exit();
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 33 53 00 	movl   $0x5333,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 dd 16 00 00       	call   406d <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 4c 53 00 	movl   $0x534c,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 b5 16 00 00       	call   406d <printf>
    exit();
    29b8:	e8 f8 14 00 00       	call   3eb5 <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 c1 52 00 00 	movl   $0x52c1,(%esp)
    29c4:	e8 3c 15 00 00       	call   3f05 <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 66 53 00 	movl   $0x5366,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 90 16 00 00       	call   406d <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 04 54 00 00 	movl   $0x5404,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 34 54 00 	movl   $0x5434,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 f1 15 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 74 54 00 00 	movl   $0x5474,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 a4 54 00 	movl   $0x54a4,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 b0 15 00 00       	call   406d <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 3b 56 00 	movl   $0x563b,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 a6 13 00 00       	call   406d <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 48 56 00 00 	movl   $0x5648,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 50 56 00 	movl   $0x5650,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 75 13 00 00       	call   406d <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    2d18:	c7 44 24 04 67 56 00 	movl   $0x5667,0x4(%esp)
    2d1f:	00 
    2d20:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d27:	e8 41 13 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 81 56 00 00 	movl   $0x5681,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 8c 56 00 	movl   $0x568c,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 0b 13 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 81 56 00 00 	movl   $0x5681,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 c7 4c 00 00 	movl   $0x4cc7,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 24 57 00 	movl   $0x5724,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 f3 11 00 00       	call   406d <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 43 57 00 	movl   $0x5743,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 a4 11 00 00       	call   406d <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 57 57 00 	movl   $0x5757,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 80 11 00 00       	call   406d <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 67 57 00 	movl   $0x5767,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 64 11 00 00       	call   406d <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 a7 57 00 00 	movl   $0x57a7,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 a7 57 00 00 	movl   $0x57a7,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 ae 44 00 00 	movl   $0x44ae,(%esp)
    2ff8:	e8 28 0f 00 00       	call   3f25 <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 aa 57 00 	movl   $0x57aa,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 5c 10 00 00       	call   406d <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 be 57 00 	movl   $0x57be,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 40 10 00 00       	call   406d <printf>
    ...
    304c:	e8 64 0e 00 00       	call   3eb5 <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 cc 57 00 	movl   $0x57cc,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 f2 0f 00 00       	call   406d <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 ee 57 00 	movl   $0x57ee,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 ce 0f 00 00       	call   406d <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 02 58 00 	movl   $0x5802,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 a1 0f 00 00       	call   406d <printf>
    exit();
    30cc:	e8 e4 0d 00 00       	call   3eb5 <exit>
  }
  
  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 15 58 00 	movl   $0x5815,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 88 0f 00 00       	call   406d <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 fc 62 00 00       	mov    0x62fc,%eax
    30f6:	c7 44 24 04 23 58 00 	movl   $0x5823,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 67 0f 00 00       	call   406d <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3144:	a1 fc 62 00 00       	mov    0x62fc,%eax
    ...
    315e:	c7 44 24 04 2e 58 00 	movl   $0x582e,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 ff 0e 00 00       	call   406d <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 fc 62 00 00       	mov    0x62fc,%eax
    31a2:	c7 44 24 04 49 58 00 	movl   $0x5849,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 bb 0e 00 00       	call   406d <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 fc 62 00 00       	mov    0x62fc,%eax
    31e5:	c7 44 24 04 60 58 00 	movl   $0x5860,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 78 0e 00 00       	call   406d <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    323e:	a1 fc 62 00 00       	mov    0x62fc,%eax
    3243:	c7 44 24 04 7c 58 00 	movl   $0x587c,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 1a 0e 00 00       	call   406d <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 fc 62 00 00       	mov    0x62fc,%eax
    328e:	c7 44 24 04 ba 58 00 	movl   $0x58ba,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 cf 0d 00 00       	call   406d <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 fc 62 00 00       	mov    0x62fc,%eax
    ...
    32d2:	c7 44 24 04 d8 58 00 	movl   $0x58d8,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 8b 0d 00 00       	call   406d <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 fc 62 00 00       	mov    0x62fc,%eax
    ...
    3339:	c7 44 24 04 10 59 00 	movl   $0x5910,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 24 0d 00 00       	call   406d <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 fc 62 00 00       	mov    0x62fc,%eax
    335d:	c7 44 24 04 38 59 00 	movl   $0x5938,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 00 0d 00 00       	call   406d <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 fc 62 00 00       	mov    0x62fc,%eax
    ...
    33ba:	c7 44 24 04 68 59 00 	movl   $0x5968,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 a3 0c 00 00       	call   406d <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 fc 62 00 00       	mov    0x62fc,%eax
    33f3:	c7 44 24 04 dd 44 00 	movl   $0x44dd,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 6a 0c 00 00       	call   406d <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 ae 48 00 	movl   $0x48ae,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 ea 0b 00 00       	call   406d <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 13 49 00 	movl   $0x4913,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 fc 62 00 00       	mov    0x62fc,%eax
    3578:	c7 44 24 04 a2 59 00 	movl   $0x59a2,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 e5 0a 00 00       	call   406d <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 fc 62 00 00       	mov    0x62fc,%eax
    35be:	c7 44 24 04 bd 59 00 	movl   $0x59bd,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 9f 0a 00 00       	call   406d <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 fc 62 00 00       	mov    0x62fc,%eax
    3604:	c7 44 24 04 cb 59 00 	movl   $0x59cb,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 59 0a 00 00       	call   406d <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 da 59 00 00 	movl   $0x59da,(%esp)
    3678:	e8 98 08 00 00       	call   3f15 <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 fc 62 00 00       	mov    0x62fc,%eax
    3687:	c7 44 24 04 e5 59 00 	movl   $0x59e5,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 d6 09 00 00       	call   406d <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 fc 62 00 00       	mov    0x62fc,%eax
    36b4:	c7 44 24 04 fe 59 00 	movl   $0x59fe,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 a9 09 00 00       	call   406d <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 fc 62 00 00       	mov    0x62fc,%eax
    36d1:	c7 44 24 04 0b 5a 00 	movl   $0x5a0b,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 8c 09 00 00       	call   406d <printf>
  for(i = 0; i < sizeof(uninit); i++){
    ...
    36f9:	a1 fc 62 00 00       	mov    0x62fc,%eax
    36fe:	c7 44 24 04 15 5a 00 	movl   $0x5a15,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 5f 09 00 00       	call   406d <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 fc 62 00 00       	mov    0x62fc,%eax
    3726:	c7 44 24 04 26 5a 00 	movl   $0x5a26,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 37 09 00 00       	call   406d <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 33 5a 00 00 	movl   $0x5a33,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 20 63 00 00 	movl   $0x5a40,0x6320(,%eax,4)
    376f:	40 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3787:	a1 fc 62 00 00       	mov    0x62fc,%eax
    378c:	c7 44 24 04 1d 5b 00 	movl   $0x5b1d,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 d1 08 00 00       	call   406d <printf>
    exec("echo", args);
    379c:	c7 44 24 04 20 63 00 	movl   $0x6320,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 3c 44 00 00 	movl   $0x443c,(%esp)
    37ab:	e8 3d 07 00 00       	call   3eed <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 fc 62 00 00       	mov    0x62fc,%eax
    37b5:	c7 44 24 04 2a 5b 00 	movl   $0x5b2a,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 a8 08 00 00       	call   406d <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 33 5a 00 00 	movl   $0x5a33,(%esp)
    ...
    37f2:	a1 fc 62 00 00       	mov    0x62fc,%eax
    37f7:	c7 44 24 04 3a 5b 00 	movl   $0x5b3a,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 66 08 00 00       	call   406d <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 33 5a 00 00 	movl   $0x5a33,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 fc 62 00 00       	mov    0x62fc,%eax
    3833:	c7 44 24 04 53 5b 00 	movl   $0x5b53,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 2a 08 00 00       	call   406d <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 33 5a 00 00 	movl   $0x5a33,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 68 5b 00 	movl   $0x5b68,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 ea 07 00 00       	call   406d <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 75 5b 00 	movl   $0x5b75,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 00 07 00 00       	call   406d <printf>
    ...
    3990:	c7 44 24 04 81 5b 00 	movl   $0x5b81,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 c9 06 00 00       	call   406d <printf>
      break;
    ...
    39dc:	c7 44 24 04 91 5b 00 	movl   $0x5b91,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 7d 06 00 00       	call   406d <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 a1 5b 00 	movl   $0x5ba1,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 59 05 00 00       	call   406d <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b1d:	a1 00 63 00 00       	mov    0x6300,%eax
    3b22:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b28:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b2d:	a3 00 63 00 00       	mov    %eax,0x6300
  return randstate;
    3b32:	a1 00 63 00 00       	mov    0x6300,%eax
}
    3b37:	5d                   	pop    %ebp
    3b38:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3b8e:	00 
    3b8f:	c7 04 24 cb 5b 00 00 	movl   $0x5bcb,(%esp)
...
putc(int fd, char c)
{
    ...
    3f90:	83 ec 18             	sub    $0x18,%esp
    3f93:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f96:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f99:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    3fa0:	00 
    3fa1:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3fa4:	89 44 24 04          	mov    %eax,0x4(%esp)
    3fa8:	8b 45 08             	mov    0x8(%ebp),%eax
    3fab:	89 04 24             	mov    %eax,(%esp)
    3fae:	e8 22 ff ff ff       	call   3ed5 <write>
}
    3fb3:	c9                   	leave  
    3fb4:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3fbd:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fc4:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fc8:	74 17                	je     3fe1 <printint+0x2c>
    3fca:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fce:	79 11                	jns    3fe1 <printint+0x2c>
    neg = 1;
    3fd0:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fd7:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fda:	f7 d8                	neg    %eax
    3fdc:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fdf:	eb 06                	jmp    3fe7 <printint+0x32>
  } else {
    x = xx;
    3fe1:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fe4:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3fe7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fee:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3ff1:	8d 41 01             	lea    0x1(%ecx),%eax
    3ff4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3ff7:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3ffa:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ffd:	ba 00 00 00 00       	mov    $0x0,%edx
    4002:	f7 f3                	div    %ebx
    4004:	89 d0                	mov    %edx,%eax
    4006:	0f b6 80 04 63 00 00 	movzbl 0x6304(%eax),%eax
    400d:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4011:	8b 75 10             	mov    0x10(%ebp),%esi
    4014:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4017:	ba 00 00 00 00       	mov    $0x0,%edx
    401c:	f7 f6                	div    %esi
    401e:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4021:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4025:	75 c7                	jne    3fee <printint+0x39>
  if(neg)
    4027:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    402b:	74 10                	je     403d <printint+0x88>
    buf[i++] = '-';
    402d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4030:	8d 50 01             	lea    0x1(%eax),%edx
    4033:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4036:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    403b:	eb 1f                	jmp    405c <printint+0xa7>
    403d:	eb 1d                	jmp    405c <printint+0xa7>
    putc(fd, buf[i]);
    403f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4042:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4045:	01 d0                	add    %edx,%eax
    4047:	0f b6 00             	movzbl (%eax),%eax
    404a:	0f be c0             	movsbl %al,%eax
    404d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4051:	8b 45 08             	mov    0x8(%ebp),%eax
    4054:	89 04 24             	mov    %eax,(%esp)
    4057:	e8 31 ff ff ff       	call   3f8d <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    405c:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4060:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4064:	79 d9                	jns    403f <printint+0x8a>
    putc(fd, buf[i]);
}
    4066:	83 c4 30             	add    $0x30,%esp
    4069:	5b                   	pop    %ebx
    406a:	5e                   	pop    %esi
    406b:	5d                   	pop    %ebp
    406c:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    4070:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4073:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    407a:	8d 45 0c             	lea    0xc(%ebp),%eax
    407d:	83 c0 04             	add    $0x4,%eax
    4080:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    4083:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    408a:	e9 7c 01 00 00       	jmp    420b <printf+0x19e>
    c = fmt[i] & 0xff;
    408f:	8b 55 0c             	mov    0xc(%ebp),%edx
    4092:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4095:	01 d0                	add    %edx,%eax
    4097:	0f b6 00             	movzbl (%eax),%eax
    409a:	0f be c0             	movsbl %al,%eax
    409d:	25 ff 00 00 00       	and    $0xff,%eax
    40a2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    40a5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    40a9:	75 2c                	jne    40d7 <printf+0x6a>
      if(c == '%'){
    40ab:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    40af:	75 0c                	jne    40bd <printf+0x50>
        state = '%';
    40b1:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    40b8:	e9 4a 01 00 00       	jmp    4207 <printf+0x19a>
      } else {
        putc(fd, c);
    40bd:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40c0:	0f be c0             	movsbl %al,%eax
    40c3:	89 44 24 04          	mov    %eax,0x4(%esp)
    40c7:	8b 45 08             	mov    0x8(%ebp),%eax
    40ca:	89 04 24             	mov    %eax,(%esp)
    40cd:	e8 bb fe ff ff       	call   3f8d <putc>
    40d2:	e9 30 01 00 00       	jmp    4207 <printf+0x19a>
      }
    } else if(state == '%'){
    40d7:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40db:	0f 85 26 01 00 00    	jne    4207 <printf+0x19a>
      if(c == 'd'){
    40e1:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40e5:	75 2d                	jne    4114 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    40e7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40ea:	8b 00                	mov    (%eax),%eax
    40ec:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    40f3:	00 
    40f4:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    40fb:	00 
    40fc:	89 44 24 04          	mov    %eax,0x4(%esp)
    4100:	8b 45 08             	mov    0x8(%ebp),%eax
    4103:	89 04 24             	mov    %eax,(%esp)
    4106:	e8 aa fe ff ff       	call   3fb5 <printint>
        ap++;
    410b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    410f:	e9 ec 00 00 00       	jmp    4200 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4114:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4118:	74 06                	je     4120 <printf+0xb3>
    411a:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    411e:	75 2d                	jne    414d <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4120:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4123:	8b 00                	mov    (%eax),%eax
    4125:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    412c:	00 
    412d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4134:	00 
    4135:	89 44 24 04          	mov    %eax,0x4(%esp)
    4139:	8b 45 08             	mov    0x8(%ebp),%eax
    413c:	89 04 24             	mov    %eax,(%esp)
    413f:	e8 71 fe ff ff       	call   3fb5 <printint>
        ap++;
    4144:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4148:	e9 b3 00 00 00       	jmp    4200 <printf+0x193>
      } else if(c == 's'){
    414d:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4151:	75 45                	jne    4198 <printf+0x12b>
        s = (char*)*ap;
    4153:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4156:	8b 00                	mov    (%eax),%eax
    4158:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    415b:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    415f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4163:	75 09                	jne    416e <printf+0x101>
          s = "(null)";
    4165:	c7 45 f4 06 5c 00 00 	movl   $0x5c06,-0xc(%ebp)
        while(*s != 0){
    416c:	eb 1e                	jmp    418c <printf+0x11f>
    416e:	eb 1c                	jmp    418c <printf+0x11f>
          putc(fd, *s);
    4170:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4173:	0f b6 00             	movzbl (%eax),%eax
    4176:	0f be c0             	movsbl %al,%eax
    4179:	89 44 24 04          	mov    %eax,0x4(%esp)
    417d:	8b 45 08             	mov    0x8(%ebp),%eax
    4180:	89 04 24             	mov    %eax,(%esp)
    4183:	e8 05 fe ff ff       	call   3f8d <putc>
          s++;
    4188:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    418f:	0f b6 00             	movzbl (%eax),%eax
    4192:	84 c0                	test   %al,%al
    4194:	75 da                	jne    4170 <printf+0x103>
    4196:	eb 68                	jmp    4200 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4198:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    419c:	75 1d                	jne    41bb <printf+0x14e>
        putc(fd, *ap);
    ...
    41b0:	e8 d8 fd ff ff       	call   3f8d <putc>
        ap++;
    41b5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    41b9:	eb 45                	jmp    4200 <printf+0x193>
      } else if(c == '%'){
    41bb:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41bf:	75 17                	jne    41d8 <printf+0x16b>
        putc(fd, c);
    ...
    41d1:	e8 b7 fd ff ff       	call   3f8d <putc>
    41d6:	eb 28                	jmp    4200 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41d8:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    41df:	00 
    41e0:	8b 45 08             	mov    0x8(%ebp),%eax
    41e3:	89 04 24             	mov    %eax,(%esp)
    41e6:	e8 a2 fd ff ff       	call   3f8d <putc>
        putc(fd, c);
    41eb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41ee:	0f be c0             	movsbl %al,%eax
    41f1:	89 44 24 04          	mov    %eax,0x4(%esp)
    41f5:	8b 45 08             	mov    0x8(%ebp),%eax
    41f8:	89 04 24             	mov    %eax,(%esp)
    41fb:	e8 8d fd ff ff       	call   3f8d <putc>
      }
      state = 0;
    4200:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    4207:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    420b:	8b 55 0c             	mov    0xc(%ebp),%edx
    420e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4211:	01 d0                	add    %edx,%eax
    4213:	0f b6 00             	movzbl (%eax),%eax
    4216:	84 c0                	test   %al,%al
    4218:	0f 85 71 fe ff ff    	jne    408f <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    425a:	89 45 fc             	mov    %eax,-0x4(%ebp)
    425d:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4260:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4263:	76 d4                	jbe    4239 <free+0x19>
    4265:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4268:	8b 00                	mov    (%eax),%eax
    426a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    426d:	76 ca                	jbe    4239 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  ...
  if(p + p->s.size == bp){
    ...
    42c8:	01 d0                	add    %edx,%eax
    42ca:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    42cd:	75 20                	jne    42ef <free+0xcf>
    p->s.size += bp->s.size;
    42cf:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d2:	8b 50 04             	mov    0x4(%eax),%edx
    42d5:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42d8:	8b 40 04             	mov    0x4(%eax),%eax
    42db:	01 c2                	add    %eax,%edx
    42dd:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42e0:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    42e3:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42e6:	8b 10                	mov    (%eax),%edx
    42e8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42eb:	89 10                	mov    %edx,(%eax)
    42ed:	eb 08                	jmp    42f7 <free+0xd7>
  } else
    p->s.ptr = bp;
    42ef:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42f2:	8b 55 f8             	mov    -0x8(%ebp),%edx
    42f5:	89 10                	mov    %edx,(%eax)
  freep = p;
    42f7:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42fa:	a3 a8 63 00 00       	mov    %eax,0x63a8
}
    42ff:	c9                   	leave  
    4300:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    431d:	89 04 24             	mov    %eax,(%esp)
    4320:	e8 18 fc ff ff       	call   3f3d <sbrk>
    4325:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4328:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    432c:	75 07                	jne    4335 <morecore+0x34>
    return 0;
    432e:	b8 00 00 00 00       	mov    $0x0,%eax
    4333:	eb 22                	jmp    4357 <morecore+0x56>
  hp = (Header*)p;
    4335:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4338:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    433b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    433e:	8b 55 08             	mov    0x8(%ebp),%edx
    4341:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4344:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4347:	83 c0 08             	add    $0x8,%eax
    434a:	89 04 24             	mov    %eax,(%esp)
    434d:	e8 ce fe ff ff       	call   4220 <free>
  return freep;
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    43fd:	eb 38                	jmp    4437 <malloc+0xde>
    }
    if(p == freep)
    43ff:	a1 a8 63 00 00       	mov    0x63a8,%eax
    4404:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    4407:	75 1b                	jne    4424 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4409:	8b 45 ec             	mov    -0x14(%ebp),%eax
    440c:	89 04 24             	mov    %eax,(%esp)
    440f:	e8 ed fe ff ff       	call   4301 <morecore>
    4414:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4417:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    441b:	75 07                	jne    4424 <malloc+0xcb>
        return 0;
    441d:	b8 00 00 00 00       	mov    $0x0,%eax
    4422:	eb 13                	jmp    4437 <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    4432:	e9 70 ff ff ff       	jmp    43a7 <malloc+0x4e>
}
    4437:	c9                   	leave  
    4438:	c3                   	ret    
